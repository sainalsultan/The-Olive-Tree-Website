          ...
          <div className="ct-left">
            ...
            <div className="ct-hours-list">
              {HOURS.map(({ day, slots, closed }) => (
                <div
                  className={`ct-hour-row${closed ? " closed" : ""}`}
                  key={day}
                >
                  <div
                    className={`ct-hour-top${
                      !closed && slots.length ? " has-slots" : ""
                    }`}
                  >
                    <div className="ct-hour-left">
                      <span
                        className={`ct-hour-dot${closed ? " closed" : ""}`}
                      />
                      <span className={`ct-hour-day${closed ? " closed" : ""}`}>
                        {day}
                      </span>
                    </div>
            ...
            <div className="ct-info">
              ...
              <div className="ct-info-row">
                ...
                <div className="ct-info-body">
                  <a href="mailto:contact@lepetitbistrot-demo.com">
                  contact@lepetitbistrot-demo.com
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="ct-right">
            <div className="map-placeholder ct-map">
              ...
              <div className="map-inner ct-map-inner">
                ...
                <small>24 Rue des Martyrs, 75009 Paris, France</small>
                <a
